<div id="add_new" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="min-height: 590px;">
            <form id="add-role-form" action="index.php/administration/role/add" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Add New <small>Roles</small>
                    </h5>
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <select multiple="" onblur="checkEmptySelect(this, 'Responsibilities', 'errorResponsibilities')" class="form-control" name="responsibilities[]" id="responsibilities">
                                                            <?php
                                                        ...
                                                        <span id="errorResponsibilities" class="text-danger"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="add_new_role();" class="btn btn-default btn-bold btn-upper btn-font-sm">Add</button>
                </div>
            </form>
        </div>
    </div>
