<div id="add_new" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="min-height: 590px;">
            <form id="add-fee-form" action="/administration/fee/add" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Add New <small>Fee</small>
                    </h5>
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <select class="form-control" name="type" id="type">
                                                            <?php
                                                                foreach(get_fees_types() as $key => $value){
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--info">
                                                            <label>
                                                                <input type="checkbox" id="is_percentage" name="is_percentage">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input class="form-control" type="number" onblur="checkEmpty(this,'Amount', 'errorAddAmount')" value="" id="amount" name="amount">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="add_fee();" class="btn btn-default btn-bold btn-upper btn-font-sm">Add</button>
                </div>
            </form>
        </div>
    </div>
