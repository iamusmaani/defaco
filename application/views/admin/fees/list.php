				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr id="category-<?php echo $value->id ?>">
                                                    ...
                                                    <td><?php echo get_fees_type_name($value->type) ?></td>
                                                    <td class="text-right"><?php echo $value->is_percentage == 1 ? "%" : "$" ?><?php echo $value->amount ?></td>
                                                    <td class="text-center"><?php echo $value->status == 1 ? "<span class='text-success'>Active" : "<span class='text-danger'>In Active</span>"; ?></td>
                                                    <td align="center">
                                                        <a href="javascrip::void(0)" onclick="get_fee_to_edit(<?php echo $value->id ?>);">
                                                            <i class="fa fa-edit text-info"></i>
                                                        </a>
                                                    </td>
                                                    <td align="center">
                                                        <a href="javascrip::void(0)" onclick="delete_fee(<?php echo $value->id ?>);">
                            ...
                            <?php $this->load->view('admin/fees/add');?>
                            <!--ends:: add form modal-->
                            <!--begin:: add form modal-->
                            <?php $this->load->view('admin/fees/edit');?>
                            <!--ends:: add form modal-->
                        </div>
						<!-- end:: Content -->
					</div>
