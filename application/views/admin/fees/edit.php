<div id="edit" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="min-height: 590px;">
            <form id="edit-fee-form" action="/administration/fee/save" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Edit <small>Fee</small>
                    </h5>
                                            ...
                                            <div class="kt-section__body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="hidden" value="" id="fee_id" name="fee_id">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="edit_fee();" class="btn btn-default btn-bold btn-upper btn-font-sm">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
