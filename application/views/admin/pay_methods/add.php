<div id="add_new" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="min-height: 590px;">
            <form id="add-paymethod-form" action="/administration/paymethod/add" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Add New <small>Payment Method</small>
                    </h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="add_pay_method();" class="btn btn-default btn-bold btn-upper btn-font-sm">Add</button>
                </div>
            </form>
        </div>
    </div>
