                                ...
                                <div class="kt-portlet__head kt-portlet__head--lg">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
                                            <button type="button" class="btn btn-brand" data-toggle="modal" data-target="#add_lead">Add Lead</button>
										</div>
									</div>
								</div>
                                <!--begin:: list table-->
                                    ...
                                    <table class="table table-bordered table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="role-<?php print_r($value->id);?>">
                                                ...
                                                <td><?php print_r(ucfirst($value->first_name)); ?> <?php print_r(ucfirst($value->last_name)); ?></td>
                                                <td><?php print_r(ucfirst($value->company)); ?></td>
                                                <td><?php print_r($value->email);?></td>
                                                <td><?php print_r($value->phone);?></td>
                                                <td><?php print_r($value->source == 1? "Website" : "Others");?></td>
                                                <td class="text-center"><?php print_r(date('m/d/Y h:i A',strtotime($value->created_at)));?></td>
                                                <td class="text-center"><?php echo $value->status == 0 ? "<span class='text-danger'>Closed</span>" : "<span class='text-success'>Active</span>";?></td>
                                                <td align="center">
