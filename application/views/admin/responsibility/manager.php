					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                            ...
                            <div class="kt-portlet kt-portlet--tabs">
                                ...
                                <div class="kt-portlet__body">
                                    <table class="table table-bordered table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr id="responsibility-<?php print_r($value->id);?>">
                                                ...
                                                <td align="right">
                                                    <a href="javascrip:" onclick="edit_responsibility(<?php print_r($value->id);?>);"><i class="fa fa-edit text-info"></i></a> &nbsp;
                                                    <a href="javascrip:" onclick="responsibility_delete(<?php print_r($value->id);?>);"><i class="fa fa-trash text-danger"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                                }
                                ...
                                <?php $this->load->view('admin/responsibility/add');?>
                                <!--ends:: add form modal-->
                                <!--begins:: edit form modal-->
                                <?php $this->load->view('admin/responsibility/edit');?>
