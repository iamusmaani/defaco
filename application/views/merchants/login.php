					...
					<div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
						<div class="kt-login__body">
							<div class="kt-login__form">
                                ...
                                ?>
                                <h4 class="text-center">Merchant Login</h4>
                                <br>
								<form action="members/merchant/process_login" id="merchant-login-form" method="POST">
									<div class="form-group">
                                        <input class="form-control" type="email" onblur="checkEmpty(this,'Email', 'errorEmail')" placeholder="Merchant Email" name="email">
                                        <span id="errorEmail" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" type="password" onblur="checkEmpty(this,'Password', 'errorPassword')" placeholder="Merchant Password" name="password">
                                        <span id="errorPassword" class="text-danger"></span>
									</div>
									<div class="form-group">
                                        <br>
                                        <input type="checkbox" name="terms"> Remember Me
										<button type="button" onclick="process_login()" class="btn btn-primary pull-right">Authenticate</button>
									</div>
								</form>
							</div>
						</div>
