<div id="edit" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="min-height: 590px;">
            <form id="edit-tax-form" action="/members/tax/save" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="edit_tax();" class="btn btn-default btn-bold btn-upper btn-font-sm">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
