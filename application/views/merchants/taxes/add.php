<div id="add_new" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="min-height: 590px;">
            <form id="add-tax-form" action="/members/tax/add" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Add New <small>Tax</small>
                    </h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="add_tax();" class="btn btn-default btn-bold btn-upper btn-font-sm">Add Tax</button>
                </div>
            </form>
        </div>
    </div>
