...
<!--begins:: Custom Script-->
<script src="assets/jscripts/merchants/mainframe.js" type="text/javascript"></script>
<script src="assets/jscripts/helper.js" type="text/javascript"></script>
<!--ends:: Custom Script-->
