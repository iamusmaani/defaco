				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr id="category-<?php echo $value->id ?>">
                                                    ...
                                                    <td><?php echo $value->parent_id == 0 ? "No Parent" : get_parent_category_name($value->parent_id); ?></td>
                                                    <td><?php echo $value->status == 1 ? "Active" : "In Active" ?></td>
                                                    <td align="center">
                                                        <a href="javascrip:" onclick="get_category_to_edit(<?php echo $value->id ?>);">
                                                            <i class="fa fa-edit text-info"></i>
                                                        </a>
                                                    </td>
                                                    <td align="center">
                                                        <a href="javascrip:" onclick="delete_category(<?php echo $value->id ?>);">
                            ...
                            <?php $this->load->view('merchants/categories/add');?>
                            <!--ends:: add form modal-->
                            <!--begin:: add form modal-->
                            <?php $this->load->view('merchants/categories/edit');?>
                            <!--ends:: add form modal-->
                        </div>
						<!-- end:: Content -->
					</div>
