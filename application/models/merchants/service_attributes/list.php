				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr id="category-<?php echo $value->id ?>">
                                                    ...
                                                    <td class="text-right">
                                                        <?php 
                                                            $taxes = get_merchant_tax($value->tax);
                                                            if(count($taxes) > 0){
                                                    ...
                                                    <td class="text-right">
                                                        <?php
                                                            $discounts = get_merchant_discount($value->discount);
                                                    ...
                                                    <td align="center">
                                                        <a href="javascrip:" onclick="get_attribute_to_edit(<?php echo $value->id ?>);">
                                                            <i class="fa fa-edit text-info"></i>
                                                        </a>
                                                    </td>
                                                    <td align="center">
                                                        <a href="javascrip:" onclick="delete_attribute(<?php echo $value->id ?>);">
                            ...
                            <?php $this->load->view('merchants/service_attributes/add');?>
                            <!--ends:: add form modal-->
                            <!--begin:: add form modal-->
                            <?php $this->load->view('merchants/service_attributes/edit');?>
                            <!--ends:: add form modal-->
                        </div>
						<!-- end:: Content -->
					</div>
