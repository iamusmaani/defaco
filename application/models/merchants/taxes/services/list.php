				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr id="category-<?php echo $value->id ?>">
                                                    ...
                                                    <td class="text-right">
                                                        <?php 
                                                            foreach(get_service_tax($value->id) as $k => $v){
                                                                echo $v->name.", ";
                                                            }
                                                        ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?php 
                                                            foreach(get_service_discount($value->id) as $k => $v){
                                                                echo $v->name.", ";
                                                            }
                                                        ?>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <?php 
                                                            foreach(get_service_media($value->id) as $k => $v){
                                                        ?>
                                                            <a onclick='preview_service_media(<?php echo $value->id?>, "<?php echo $v->media?>")'><i class='fa fa-film text-info'></i> </a>
                                                        <?php
                                                            }
                                                        ?>
                                                    </td>
                                                    <td><?php echo $value->status == 1 ? "<i class='fa fa-power-off text-success'></i>" : "<i class='fa fa-power-off text-danger'></i>"; ?></td>
                                                    <td align="center">
                                                        <a onclick="get_service_to_edit(<?php echo $value->id ?>);">
                                                            <i class="fa fa-edit text-info"></i>
                                                        </a>
                                                    </td>
                                                    <td align="center">
                                                        <a onclick="delete_service(<?php echo $value->id ?>);">
                            ...
                            <!--ends:: add form modal-->
                            <!--begin:: preview media modal-->
                            <?php $this->load->view('merchants/preview-media');?>
                            <!--ends:: prview media modal-->
                        </div>
						<!-- end:: Content -->
					</div>
					<!-- begin:: Footer -->
